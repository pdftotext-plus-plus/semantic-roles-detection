...
from semantic_roles_detection.utils import image_utils
...
from semantic_roles_detection.utils.models import TextBlock
...
def evaluate(args):
    ...
    bpe_vocab = vocab_reader.read(os.path.join(args.model_dir, BPE_VOCAB_FILE_NAME))
    roles_vocab = vocab_reader.read(os.path.join(args.model_dir, ROLES_VOCAB_FILE_NAME))
    ...
    LOG.info(f"Loading model '{args.model_dir}' ...")
    ...
    for i, text_block in enumerate(text_blocks):
      print("==========")
      print("Text:   ", text_block.text)
      print("Layout: ", layout_seqs[i])
      print("Words:  ", word_seqs[i])
